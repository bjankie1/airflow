...
from environments.kubernetes.gke.collecting_results.metrics_dataframe import (
    convert_time_series_to_dataframes,
...
from environments.kubernetes.gke.collecting_results.monitoring_api.monitored_resources import (
...
def get_monitored_resources_map(cluster_id: str, airflow_namespace_prefix: str) -> Dict[ResourceType, Dict]:
    """
